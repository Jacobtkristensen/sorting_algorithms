<template>
    <div class="min-h-full">
      ...
      <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold tracking-tight text-gray-900">Radix Sort</h1>
        </div>
      </header>
  
      <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <p class="text-center text-gray-500">This is the Radix Sort algorithm page. Use the buttons and slider to start visualizing.</p>
          <ButtonGroup
            algorithmName="Radix"
            @generateArray="generateArray"
            @sortArray="startRadixSort"
  ...
  const startRadixSort = () => {
    radixSort(array.value, (updatedArray) => {
