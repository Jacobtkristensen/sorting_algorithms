<template>
    <div class="min-h-full">
      ...
      <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold tracking-tight text-gray-900">Merge Sort</h1>
        </div>
      </header>
  
      <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <p class="text-center text-gray-500">This is the Merge Sort algorithm page. Use the buttons and slider to start visualizing.</p>
          <ButtonGroup
            algorithmName="Merge"
            @generateArray="generateArray"
            @sortArray="startMergeSort"
  ...
  const startMergeSort = () => {
    mergeSort(array.value, (updatedArray) => {
